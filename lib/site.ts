...
export const packages: Package[] = [
  {
    ...
    blurb: "One narrow problem, solved end to end, so you can judge the result before committing further.",
    features: [
      "A single assistant, extractor or automation",
      "Working against your real data",
  ...
  },
  {
    name: "Build",
    price: "Request a quote",
    blurb: "A production AI application: auth, roles, dashboards, cost controls and the boring parts that keep it alive.",
    features: [
      "Custom AI application or SaaS",
      "Database, admin and integrations",
      "Rate limiting and token cost caps",
  ...
  },
  {
    name: "Partner",
    price: "Request a quote",
    blurb: "Ongoing engineering for teams shipping AI continuously, or an outside review of a system already running.",
    features: [
      "Retained engineering time",
      "AI systems and code review",
